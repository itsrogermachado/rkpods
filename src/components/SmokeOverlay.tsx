export function SmokeOverlay() {
  return (
    <div className="fixed inset-0 overflow-hidden pointer-events-none z-[1]">
      ...
      <div 
        className="absolute bottom-10 -left-10 w-[450px] h-[450px] rounded-full animate-smoke-swirl"
        style={{ 
      ...
      <div 
        className="absolute -bottom-10 right-1/4 w-[550px] h-[550px] rounded-full animate-smoke-breathe"
        style={{ 
      ...
      <div 
        className="absolute top-2/3 left-1/4 w-[400px] h-[400px] rounded-full animate-smoke-rise"
        style={{ 
      ...
      <div 
        className="absolute top-1/2 right-10 w-[480px] h-[480px] rounded-full animate-smoke-float"
        style={{ 
      ...
      <div 
        className="absolute -top-5 left-1/3 w-[520px] h-[520px] rounded-full animate-smoke-swirl"
        style={{ 
      ...
      {/* Camada 9 - Extra grande atrás de tudo */}
      <div 
        className="absolute top-1/3 left-1/2 -translate-x-1/2 w-[800px] h-[800px] rounded-full animate-vapor-pulse"
        style={{ 
      ...
      <div 
        className="absolute bottom-1/4 left-1/2 w-[300px] h-[300px] rounded-full animate-smoke-drift"
        style={{ 
