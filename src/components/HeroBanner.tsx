...
export function HeroBanner() {
  return <section className="relative overflow-hidden gradient-primary py-16 md:py-24">
      {/* Background Pattern */}
      ...
      <div className="container relative">
        <div className="grid md:grid-cols-2 gap-8 items-center">
          ...
          <div className="text-center md:text-left space-y-6 animate-fade-in">
            ...
            <p className="text-lg text-white/80 max-w-md mx-auto md:mx-0">Pods</p>
          ...
          <div className="hidden md:flex justify-center animate-scale-in">
            <div className="relative">
              ...
              <img src="https://images.unsplash.com/photo-1560472354-b33ff0c44a43?w=500" alt="Vapes e Pods" className="relative w-80 h-80 object-cover rounded-3xl shadow-2xl rotate-3 hover:rotate-0 transition-transform duration-500" />
            </div>
          </div>
        </div>
      </div>
