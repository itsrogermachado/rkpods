...
export function PromoBanner() {
  return <section className="py-12 gradient-secondary">
...
export function CTABanner() {
  return <section className="py-16 gradient-warm">
      <div className="container text-center">
        <div className="max-w-2xl mx-auto space-y-6">
          ...
          <Button asChild size="lg" className="bg-white text-orange-600 hover:bg-white/90 text-lg px-8">
